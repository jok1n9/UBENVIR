...
<link rel="stylesheet" href="store.css" media="screen">
  ...
  <body class="u-body u-overlap u-xl-mode">
	...
	C20.296,39.899,19.65,40.986,18.613,41.552z"></path><g><path style="fill:#556080;" d="M26.953,0.004C12.32-0.246,0.254,11.414,0.004,26.047C-0.138,34.344,3.56,41.801,9.448,46.76
        ...
        <a href="redirect3.php" class="u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-none u-text-palette-1-base u-btn-2"><?php echo "Olá, ", $user_data['username']; ?>(logout)</a>
      </div>
    ...
    <section class="u-align-left u-clearfix u-section-2" id="sec-0340">
      ...
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        ...
        <div class="fr-view u-clearfix u-rich-text u-text u-text-1">
          ...
          $result = mysqli_query($con, "SELECT * FROM companhia where id = '$produto'");
          $result2= mysqli_fetch_array($result);
          echo $result2['Nome']; ?></h1>

          <p style="text-align: left;">
          
            <span style="line-height: 2.0;"><?php echo $result2['descricao'];?></span>
          </p>
        </div>
      </div>
    </section>
